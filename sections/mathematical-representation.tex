...
These can be represented as graphs where nodes are states in $Q$ and
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}
      ...
      \node[state]           (q_0)    [above right of=start] {$q_1$};
      \node[state]           (q_1)    [      right of=q_0]   {$q_2$};
      \node[state]           (q_2)    [      right of=q_1]   {$q_3$};
      \node[state,accepting] (q_3)    [      right of=q_2]   {$q_4$};
      \node[state]           (q_0p)   [below right of=start] {$q_1^\prime$};
      \node[state]           (q_1p)   [      right of=q_0p]  {$q_2^\prime$};
      \node[state,accepting] (q_2p)   [      right of=q_1p]  {$q_3^\prime$};
