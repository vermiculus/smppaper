...
When such predicates and moves have been consolidated into a library,
  ...
  \todo[r/w]{I feel like I'm using the word `interface' too much}
...
style=pythonex,
float,
caption={\directory{ind-set.ssax}: an example of predicate\slash move documentation.},
label={lst:iface:pred-move-documentation},
litkey=example-predicate,
