    ...
    \begin{column}{.45\textwidth}
      \begin{block}{The Bundle Format}
        ...
        \item Basic components (predicates\slash moves) are maintained
          ...
          directory structure within \directory{{$\langle$\itshape bundle$\rangle$}.ssax}
        \end{itemize}
...
\end{lstlisting}
        ...
        with all necessary files, such as \directory{ind-set.ssax/predicates/enter.py}
        \vspace{.3in}
...
\end{lstlisting}
      ...
      \begin{block}{Interface and Architecture}
        ...
        \fcolorbox{black!50}{black!50}{\includegraphics[width=.49\linewidth]{../figs/4}}
        \hfill
