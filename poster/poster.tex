...
\end{lstlisting}
      ...
      \begin{block}{Interface and Architecture}
        ...
        \begin{tikzpicture}[scale=4,
          ...
          \node[bullet,label=right:$\Set{M_1,M_4}$] (m4) at (4,1) {};
          \node[bullet,label=right:$\Set{M_2,M_3}$] (m3) at (4,2) {};
          \node[bullet,label=right:$\Set{M_1,M_0}$] (m2) at (4,3) {};
          \node[bullet,label=right:$\Set{M_3,M_4}$] (m1) at (4,4) {};
